Plugin allows you to add a new Redshift Light that updates its name based on x-y position and also renames it based on whether it's a Key or Fill light depending on the intensity of the light
